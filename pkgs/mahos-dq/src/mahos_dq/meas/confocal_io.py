...
from mahos_dq.msgs.confocal_msgs import Image, Trace, ScanDirection, update_image, update_trace
...
class ConfocalIO(object):
    ...
    def _export_trace_text(self, fn, trace: Trace):
        ...
        with open(fn, "w", encoding="utf-8", newline="\n") as fo:
            fo.write("# PD trace data taken by mahos_dq.meas.confocal. Saved at: %s\n" % (tim,))
