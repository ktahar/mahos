...
class Ui_ODMR(object):
    def setupUi(self, ODMR):
        ...
        self.gridLayout_2.addWidget(self.mwoffsetBox, 6, 3, 1, 1)
        ...
        self.postgatedelayBox = QtWidgets.QDoubleSpinBox(parent=self.measTab)
        self.postgatedelayBox.setDecimals(4)
        self.postgatedelayBox.setObjectName("postgatedelayBox")
        self.gridLayout_2.addWidget(self.postgatedelayBox, 4, 3, 1, 1)
        ...
        ODMR.setTabOrder(self.finaldelayBox, self.windowBox)
        ODMR.setTabOrder(self.windowBox, self.gatedelayBox)
        ODMR.setTabOrder(self.gatedelayBox, self.postgatedelayBox)
        ODMR.setTabOrder(self.postgatedelayBox, self.laserdelayBox)
    ...
    def retranslateUi(self, ODMR):
        ...
        self.postgatedelayBox.setPrefix(_translate("ODMR", "Post gate delay: "))
        self.postgatedelayBox.setSuffix(_translate("ODMR", " ms"))
