...
class Ui_SPODMR(object):
    def setupUi(self, SPODMR):
        ...
        self.gridLayout_2.addWidget(self.powerBox, 3, 2, 1, 1)
        ...
        self.partialBox.addItem("")
        self.partialBox.addItem("")
        self.gridLayout_2.addWidget(self.partialBox, 6, 2, 1, 1)
        self.pgfreqLabel = QtWidgets.QLabel(parent=self.groupBox_2)
        self.pgfreqLabel.setObjectName("pgfreqLabel")
        self.gridLayout_2.addWidget(self.pgfreqLabel, 5, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.nomw1Box, 4, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.power1Box, 4, 2, 1, 1)
        self.nomwBox = QtWidgets.QCheckBox(parent=self.groupBox_2)
        self.nomwBox.setObjectName("nomwBox")
        self.gridLayout_2.addWidget(self.nomwBox, 3, 3, 1, 1)
        ...
        SPODMR.setTabOrder(self.lockinrepBox, self.pdrateBox)
