...
class Ui_FitWidget(object):
    def setupUi(self, FitWidget):
        ...
        self.reverseBox = QtWidgets.QCheckBox(parent=self.verticalLayoutWidget)
        self.reverseBox.setObjectName("reverseBox")
        self.horizontalLayout.addWidget(self.reverseBox)
    ...
    def retranslateUi(self, FitWidget):
        ...
        self.reverseBox.setToolTip(_translate("FitWidget", "reverse plotting order"))
        self.reverseBox.setText(_translate("FitWidget", "rev"))
