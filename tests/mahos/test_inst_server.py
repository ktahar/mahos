...
from mahos_dq.msgs.confocal_msgs import Axis
...
def test_overlay(server_2clients):
    ...
    assert client.module_class_names("scanner") == (
        "mahos_dq.inst.overlay.confocal_scanner_mock",
        "ConfocalScanner_mock",
    )
    assert client.module_name("scanner") == "mahos_dq.inst.overlay.confocal_scanner_mock"
